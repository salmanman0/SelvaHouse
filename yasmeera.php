<div class="container" id="app">
	<div class="row pt-5">
		<div class="col-12">
			<h3 class="text-center mt-5"><img src="<?= base_url('assets/interface/logoYasmeera.png')?>"class="logo" alt="">YASMEERA
			</h3>
	...
	<div class="row pb-4">
		<div class="card-columns mt-4 pt-3 mt-prod">
			...
			<?php if(ucfirst($br['merk'])=="Yasmeera") {?>
